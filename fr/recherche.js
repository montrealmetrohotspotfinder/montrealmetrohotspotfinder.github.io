function init(){
	...
	"Parc Molson", "Paroisse Saint-Mathieu", "Paroisse Saint-Barth&eacute;lemy", "Club L" ];
	
	Ibervilletypes = [ "Magasinage", "Parc", "&Eacute;cole", "&Eacute;glise", "Parc", "&Eacute;glise", "&Eacute;glise", "Restaurant" ];
	
	Ibervilleaddresses = [ "2550 Rue Jean-Talon Est", "7069 Rue Sagard", "7081 Avenue des &Eacute;rables", "2200 Rue Jean-Talon Est", "2473 Rue Beaubien Est",
	"2600 Rue Jean-Talon Est", "7137 Avenue des &Eacute;rables", "2570 Rue Jean-Talon Est" ];
	...
	DeCastelnautypes = [ "District", "March&eacute;", "Parc", "Sports", "&Eacute;cole", "&Eacute;glise", "&Eacute;glise", "Parc", "Parc", "Parc", "Magasinage", "Parc" ];
	...
	UdeMtypes = [ "Universit&eacute;", "Coll&egrave;ge", "H&ocirc;pital", "&Eacute;cole", "Universit&eacute;", "Universit&eacute;", "Universit&eacute;", "Universit&eacute;", "Universit&eacute;", "Universit&eacute;", "Universit&eacute;", "Universit&eacute;", "Biblioth&egrave;que" ];
	...
	"Institut Universitaire en Sant&eacute; Mentale de Montr&eacute;al", "Les Appartements Place Versailles", "Le Symbiose", "Centre de R&eacute;adaptation en D&eacute;ficience Physique Raymond-Dewar Radisson", "Place de l&#39;Authion" ];
	...
	"Coll&egrave;ge", "Parc", "R&eacute;sidence", "&Eacute;cole", "H&ocirc;pital", "R&eacute;sidence", "R&eacute;sidence", "H&ocirc;pital", "R&eacute;sidence" ];
	...
	"3075 Rue Paul-David", "3800 Rue Radisson", "5975 Avenue de l&#39;Authion" ];
	...
	"New Milano", "Vincent Sous-Marins" ];
	...
	"&Eacute;cole", "R&eacute;sidence", "&Eacute;cole", "&Eacute;glise", "Parc", "&Eacute;cole", "Restaurant", "Restaurant" ];
	...
	"6625 Rue de Marseille", "6647 Rue de Marseille" ];
	...
	Cadillactypes = [ "R&eacute;sidence", "Salle de R&eacute;ception", "H&ocirc;tel", "Parc", "Parc", "&Eacute;cole", "&Eacute;cole", "&Eacute;glise", "Parc", "Agence", "Centre Culturel", "Parc" ];
	...
	Frontenactypes = [ "Centre Commercial", "Th&eacute;&acirc;tre", "Restaurant", "Parc", "Centre Culturel", "Parc", "Parc", "&Eacute;cole", "Mosqu&eacute;e", "&Eacute;cole", "&Eacute;cole", "&Eacute;cole de M&eacute;tiers", "Parc", "&Eacute;cole", "R&eacute;sidence", "R&eacute;sidence", "&Eacute;glise", "Bureau", "Parc", "Parc", "Parc" ];
	...
	Beaudrytypes = [ "District", "Bureau", "Restaurant", "Th&eacute;&acirc;tre", "Parc", "Parc", "Th&eacute;&acirc;tre", "Restaurant", "Parc", "Parc", "&Eacute;cole", "Parc", "Parc", "Sports", "Parc", "R&eacute;sidence", "&Eacute;glise" ];
	...
	"R&eacute;sidence", "R&eacute;sidence", "Bureau", "H&ocirc;tel", "Agence", "Agence", "Restaurant" ];
	...
	"405 Rue de la Concorde", "2100 Rue de Bleury", "1250 Rue Saint-Alexandre", "250 Boulevard Ren&eacute;-L&eacute;vesque Ouest", "305 Boulevard Ren&eacute;-L&eacute;vesque Ouest", "150 Rue Sainte-Catherine Ouest",
	"292 Rue Sainte-Catherine Ouest" ];
	...
	"http://www.jackvictor.com/fr/",
	"https://www.marriott.fr/hotels/travel/yulac-ac-hotel-montreal-downtown",
	"https://www.canada.ca/fr/agence-revenu.html",
	"https://www.cnesst.gouv.qc.ca/fr",
	"https://www.5sensescafe.com" ];
	...
	McGillnames = [ "Universit&eacute; McGill",
		...
		"Air Alg&eacute;rie, bureaux montr&eacute;alais" ];
	...
	"https://www.interactivebrokers.ca/fr/home.php", "https://www.cnacanada.ca/web/guest/cnacanada/home?language=fr", "https://airalgerie.dz" ];
	...
	"Restaurant", "Restaurant", "Restaurant", "Restaurant", "Restaurant", "Restaurant", "H&ocirc;tel", "Site Historique", "Site Historique", "Restaurant", "Restaurant",
	"Restaurant"];
	...
	"http://hotelchezswann.com/fr", "https://www.chezalexandre.com/", "https://ferreiracafe.com/fr/", "http://www.iberica.ca/", "https://vascodagama.ca/fr/", "https://www.restaurantzante.ca/?lang=fr", "https://campomtl.com/fr/", "https://hotelambrose.ca/fr", "https://www.patrimoine-culturel.gouv.qc.ca/rpcq/detail.do?methode=consulter&id=92828&type=bien", "https://www.patrimoine-culturel.gouv.qc.ca/rpcq/detail.do?methode=consulter&id=92829&type=bien",
	"https://montreal.lasociete.ca/", "https://leboulevardierrestaurant.com", "#" ];
	...
	Verduntypes = [ "Centre Culturel", "Gouvernement", "Parc", "&Eacute;cole", "&Eacute;cole", "Parc", "&Eacute;glise", "&Eacute;cole", "&Eacute;glise", "Centre Culturel", "&Eacute;glise" ];
	...
	Cremazietypes = [ "Agence", "Coll&egrave;ge", "Coll&egrave;ge", "Sports", "Agence", "&Eacute;cole", "Agence", "Parc", "Sports", "Coll&egrave;ge", "Agence", "Agence", "Agence", "Agence", "Parc", "Agence" ];
	...
	Lauriertypes = [ "Studio", "Parc", "&Eacute;cole", "&Eacute;cole", "&Eacute;glise", "&Eacute;cole", "&Eacute;cole", "Parc", "Parc", "Parc", "&Eacute;cole", "Restaurant", "Restaurant" ];
	...
	MontRoyalnames = [ "Parc Mont-Royal", "L&#39;Avenue du Mont-Royal", "Th&eacute;&acirc;tre du Rideau Vert", "Biblioth&egrave;que du Plateau-Mont-Royal", "Sanctuaire du Saint-Sacrement", "Parc Albert-Saint-Martin",
		 "Place G&eacute;rald-Godin", "Relais Mont-Royal", "Parc Denise-Morelle", "Parc &Eacute;mile-Nelligan", "Parc Gilles-Lefebvre", "Parc Pierre-Boucher", 
		  "Parc Palomino-Brind&#39;Amour", "Conservatoire de Musique de Montr&eacute;al", "Place des Fleurs-de-Macadam", "La Banquise", "Beautys", "Parc Jeanne-Mance" ];
	
	MontRoyaltypes = [ "Parc", "District", "Th&eacute;&acirc;tre", "Biblioth&egrave;que", "&Eacute;glise", "Parc", "Parc", "&Eacute;glise", "Parc", "Parc", "Parc", "Parc", "Parc", "&Eacute;cole", "Parc", "Restaurant", 
		"Restaurant", "Parc" ];
	...
	MontRoyaladdresses = [ "1260 Chemin Remembrance", "1012 Avenue du Mont-Royal Est", "4664 Rue Saint-Denis", "465 Avenue du Mont-Royal Est", "500 Avenue du Mont-Royal Est", "",
		     "", "500 Avenue du Mont-Royal Est", "4394 Rue Rivard", "4543 Avenue Laval", "4535 Avenue Henri-Julien", "", "", "4750 Avenue Henri-Julien", "", "994 Rue Rachel Est", 
		     "93 Avenue du Mont-Royal Ouest", "4422 Avenue de l&#39;Esplanade" ];
	...
	"https://montreal.ca/lieux/parc-palomino-brindamour", "https://www.conservatoire.gouv.qc.ca/", "https://montreal.ca/lieux/place-des-fleurs-de-macadam", "https://labanquise.com/", "https://beautys.ca/", "https://montreal.ca/lieux/parc-jeanne-mance" ];
	...
	"&Eacute;cole au Pied-de-la-Montagne", "Les Fusiliers Mont-Royal", "H&ocirc;tel Manoir Sherbrooke", "H&ocirc;tel Espace Confort", "H&ocirc;tel St-Thomas", "La Fabrique", "L&#39;&Eacute;vidence", "H&ocirc;tel de Paris", "Caf&eacute; Cherrier", "Parc Laval" ];
	...
	"H&ocirc;tel", "&Eacute;cole", "&Eacute;cole", "&Eacute;cole", "&Eacute;cole", "Parc", "&Eacute;cole", "H&ocirc;pital", "Parc", "Parc", "&Eacute;cole", "Mus&eacute;e", "H&ocirc;tel", "H&ocirc;tel", "H&ocirc;tel", "Restaurant", "Restaurant", "H&ocirc;tel", "Restaurant", "Parc" ];
	...
	"https://montreal.ca/lieux/parc-laval" ];
	...
	ChampDeMarstypes = [ "District", "Port", "Parc", "H&ocirc;pital", "District", "Place de la Ville", "Site Historique", "Gouvernement", "Gouvernement", "Site Historique", "Magasinage", "Restaurant", "&Eacute;glise", "District", "Port", "Port", "Lac",
	...
	ChampDeMarssites = [ "https://vieuxmontreal.ca/", "https://www.vieuxportdemontreal.com/", "https://montreal.ca/lieux/place-des-montrealaises", "https://www.chumontreal.qc.ca/", "https://www.mtl.org/fr/experience/quartier-chinois-montreal", 
	...
	"Terrasse Place d&#39;Armes", "Kyo Bar Japonais", "Holiday Inn Montr&eacute;al Centre-Ville Downtown", "H&ocirc;tel Uville", "Auberge de la Place Royale", "Embassy Suites by Hilton Montr&eacute;al",
	...
	"Place Marguerite-Bourgeoys", "&Eacute;cole du Barreau", "Modavie", "Toqu&eacute;!", "Pub Saint Pierre", "Terrasse sur l&#39;Auberge", "Restaurant Oskar", "Brasserie 701", "Restaurant Sauvage", "Humaniti H&ocirc;tel Montr&eacute;al", "Hayat",
	"Stash Caf&eacute;", "Restaurant Gandhi", "Chifa" ];
	...
	"Site Historique", "Bureau", "Bureau", "H&ocirc;tel", "Gouvernement", "Centre Commercial", "H&ocirc;tel", "Restaurant", "Restaurant", "H&ocirc;tel", "H&ocirc;tel", "H&ocirc;tel", "H&ocirc;tel", "H&ocirc;tel", "Restaurant", "H&ocirc;tel", "Restaurant", "Restaurant", "Restaurant",
	...
	"Bureau", "Tribunal", "Agence", "Bureau", "H&ocirc;tel", "Parc", "&Eacute;cole", "Restaurant", "Restaurant", "Restaurant", "Restaurant", "Restaurant", "Restaurant", "Restaurant", "H&ocirc;tel", "Restaurant", "Restaurant", "Restaurant", "Restaurant" ];
	...
	"507 Place d&#39;Armes", "100 Rue Notre-Dame Est", "1 Rue Notre-Dame Est", "63 Rue de Br&eacute;soles", "445 Rue Saint-Jean-Baptiste", "", "445 Boulevard Saint-Laurent", "1 Rue Saint-Paul Ouest", "900 Place Jean-Paul-Riopelle", "410 Rue Saint-Pierre", "97 Rue de la Commune Est", "414 Rue Saint-Sulpice", "701 C&ocirc;te de la Place d&#39;Armes", "52 Rue Saint-Jacques",
	"340 Rue de la Gaucheti&egrave;re Ouest", "131 Rue de la Commune Ouest", "200 Rue Saint-Paul Ouest", "230 Rue Saint-Paul Ouest", "1080 Rue de Bleury" ];
	...
	"Place du Fr&egrave;re-Andr&eacute;", "Toqu&eacute;!", "Terrasse W Montr&eacute;al", "H&ocirc;tel St-Paul", "The Farsides", "Holder", "Le Cartet Resto Boutique", "Dandy", "Le 409", "Monarque", "&Eacute;difice du Grand Tronc", "Helena", "Le Butterfly", 
	...
	"Bureau", "Bureau", "R&eacute;sidence", "Bureau", "H&ocirc;tel", "R&eacute;sidence", "Place de la Ville", "R&eacute;sidence", "Bureau", "Parc", "Restaurant", "Restaurant", "H&ocirc;tel", "Restaurant", "Restaurant", "Restaurant", "Restaurant", "Restaurant", "Restaurant", "Gouvernement", "Restaurant", "Restaurant",
	"Bureau" ];
	...
	"901 Rue du Square-Victoria", "355 Rue McGill", "690 Rue Notre-Dame Ouest", "407 Rue McGill", "106 Rue McGill", "244 Rue Saint-Jacques", "409 Rue McGill", "406 Rue Saint-Jacques", "360 Rue McGill", "438 Rue McGill", "324 Rue Saint-Paul Ouest",
	...
	"https://hotelstpaul.com/fr/", "https://www.thefarsides.com/?lang=fr", "http://restaurantholder.com/", "https://lecartet.ca/", "http://dandymtl.com/fr/", "https://le409.com/", "https://restaurantmonarque.ca/", "https://imtl.org/edifices/edifice_Grand_Tronc.php", "https://restauranthelena.com/", "https://lebutterflymtl.com",
	"https://www.bnc.ca/coordonnees/siege-social.html" ];
	...
	"Telus, bureaux montr&eacute;alais", "AlphaCCO", "Curateur Public du Qu&eacute;bec", "Ordre des Dentistes du Qu&eacute;bec", "Bombardier", "Place Banque Nationale", "Espace CDPQ" ];
	...
	"Bureau", "&Eacute;glise", "Place de la Ville", "Bureau", "Salle de R&eacute;ception", "Agence", "H&ocirc;tel", "Place de la Ville", "Bureau", "Restaurant", "Bureau", "Bureau", "Agence", "Agence", "Bureau",
	"Bureau", "Bureau" ];
	...
	"800 Boulevard Ren&eacute;-L&eacute;vesque Ouest", "800 Rue Saint-Jacques", "3 Place Ville Marie" ];
	...
	"https://www.vargas.ca/?lang=fr", "https://www.telus.com/fr/", "https://alphacco.com/", "https://www.curateur.gouv.qc.ca/cura/fr/index.html", "http://www.odq.qc.ca/Accueil/tabid/127/language/fr-CA/Default.aspx", "https://bombardier.com/fr", "https://www.bnc.ca/coordonnees/siege-social.html",
	"https://espacecdpq.com/fr" ];
	...
	"1250 Ren&eacute;-L&eacute;vesque", "Parc Julia-Drummond", "Auberge Les Bons Matins", "Roccabella", "CGI, bureaux montr&eacute;alais" ];
	
	LucienLAlliertypes = [ "Sports", "Bureau", "R&eacute;sidence", "Coll&egrave;ge", "Bureau", "Bureau", "Coll&egrave;ge", "H&ocirc;tel", "H&ocirc;tel", "H&ocirc;tel", "H&ocirc;tel", "H&ocirc;tel", "Coll&egrave;ge", "Agence", "Bureau", "H&ocirc;tel", "Bureau", "Parc", "H&ocirc;tel", "R&eacute;sidence", "Bureau" ];
	...
	"Arthurs Nosh Bar", "&Eacute;glise Saint-Zotique", "Tacos Frida", "Biblioth&egrave;que Saint-Henri", "Eva&#39;s", "Gite L&#39;Impr&eacute;vu",
	"Parc de la Ferme-Brodie", "Parc des Selliers", "Parc Lacasse", "Parc des Couturi&egrave;res", "Parc du Premier-Chemin-de-Fer" ];
	...
	"Restaurant", "&Eacute;glise", "Restaurant", "Biblioth&egrave;que", "Restaurant", "H&ocirc;tel", "Parc", "Parc", "Parc", "Parc", "Parc" ];
	...
	"4707 Rue Notre-Dame Ouest", "3981 Rue Notre-Dame Ouest", "3932 Rue Saint-Jacques", "3977 Rue Saint-Jacques", "712 Rue Lacasse", "", "", "4041 Rue Notre-Dame Ouest" ];
	...
	"#", "https://www.imprevu.org/index.html", "https://montreal.ca/lieux/parc-de-la-ferme-brodie", "https://montreal.ca/lieux/parc-des-selliers", "https://montreal.ca/lieux/parc-lacasse", 
	"https://montreal.ca/lieux/parc-des-couturieres", "https://montreal.ca/lieux/parc-du-premier-chemin-de-fer" ];
