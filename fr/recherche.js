function init(){
	...
	LionelGroulxtypes = [ "March&eacute;", "Parc", "Th&eacute;&acirc;tre", "Parc", "&Eacute;cole", "Bureau", "&Eacute;glise", "R&eacute;sidence", "Restaurant", "Restaurant" ];
	...
	"&Eacute;cole Saint-Pascal-Baylon", "Parc Martin-Luther-King", "Coll&egrave;ge Jean-de-Br&eacute;beuf" ];
	...
	"&Eacute;cole", "Parc", "Coll&egrave;ge" ];
	...
	"6320 Chemin de la C&ocirc;te-des-Neiges", "3453 Avenue de Kent", "3200 Chemin de la C&ocirc;te-Sainte-Catherine" ];
	...
	"https://st-pascal-baylon.cssdm.gouv.qc.ca/", "https://montreal.ca/lieux/parc-martin-luther-king", "https://www.brebeuf.qc.ca/" ];
	...
	"Institut Universitaire en Sant&eacute; Mentale de Montr&eacute;al" ];
	...
	"Coll&egrave;ge", "Parc", "R&eacute;sidence", "&Eacute;cole", "H&ocirc;pital" ];
	...
	"R&eacute;sidence", "R&eacute;sidence", "Bureau", "H&ocirc;tel" ];
	...
	"405 Rue de la Concorde", "2100 Rue de Bleury", "1250 Rue Saint-Alexandre", "250 Boulevard Ren&eacute;-L&eacute;vesque Ouest" ];
	...
	"https://www.summitmanagement.ca/apartments/le-smith",
	...
	"Restaurant", "Restaurant", "Restaurant", "Restaurant", "Restaurant", "Restaurant", "H&ocirc;tel", "Site Historique", "Site Historique", "Restaurant" ];
	...
	"&Eacute;cole au Pied-de-la-Montagne", "Les Fusiliers Mont-Royal", "H&ocirc;tel Manoir Sherbrooke", "H&ocirc;tel Espace Confort", "H&ocirc;tel St-Thomas" ];
	...
	"H&ocirc;tel", "&Eacute;cole", "&Eacute;cole", "&Eacute;cole", "&Eacute;cole", "Parc", "&Eacute;cole", "H&ocirc;pital", "Parc", "Parc", "&Eacute;cole", "Mus&eacute;e", "H&ocirc;tel", "H&ocirc;tel", "H&ocirc;tel" ];
	...
	"311 Avenue des Pins Est", "3721 Avenue Henri-Julien", "157 Rue Sherbrooke Est", "2050 Rue Saint-Denis", "430 Rue Sherbrooke Est" ];
	...
	"John Michael&#39;s Pub", "Jacopo", "Restaurant Papillon", "Trattoria Gio", "Restaurant Jacques-Cartier", "La Mar&eacute;e", "Pincette Bar &agrave; Homard", "Brasserie 321" ];
	...
	"Place de la Ville", "Centre Culturel", "H&ocirc;tel", "H&ocirc;tel", "Restaurant", "Restaurant", "Restaurant", "Restaurant", "Restaurant", "Restaurant", "Restaurant", "Restaurant", "Restaurant", "Restaurant", "Restaurant", "Restaurant", "Restaurant" ];
	...
	"458 Place Jacques-Cartier", "436 Place Jacques-Cartier", "85 Rue Saint-Paul Est", "452 Place Jacques-Cartier", "444 Place Jacques-Cartier", "404 Place Jacques-Cartier", "94 Rue Saint-Paul Est", "321 Place Jacques-Cartier" ];
	...
	"Place Marguerite-Bourgeoys", "&Eacute;cole du Barreau", "Modavie", "Toqu&eacute;!", "Pub Saint Pierre", "Terrasse sur l&#39;Auberge", "Restaurant Oskar", "Brasserie 701", "Restaurant Sauvage" ];
	...
	"Bureau", "Tribunal", "Agence", "Bureau", "H&ocirc;tel", "Parc", "&Eacute;cole", "Restaurant", "Restaurant", "Restaurant", "Restaurant", "Restaurant", "Restaurant", "Restaurant" ];
	...
	"http://restaurantoskar.com/fr/", "https://brasserie701.com/", "https://www.restaurantsauvage.com/" ];
	...
	"Place du Fr&egrave;re-Andr&eacute;", "Toqu&eacute;!", "Terrasse W Montr&eacute;al", "H&ocirc;tel St-Paul", "The Farsides", "Holder", "Le Cartet Resto Boutique", "Dandy", "Le 409", "Monarque" ];
	...
	"Bureau", "Bureau", "R&eacute;sidence", "Bureau", "H&ocirc;tel", "R&eacute;sidence", "Place de la Ville", "R&eacute;sidence", "Bureau", "Parc", "Restaurant", "Restaurant", "H&ocirc;tel", "Restaurant", "Restaurant", "Restaurant", "Restaurant", "Restaurant", "Restaurant" ];
	...
	"901 Rue du Square-Victoria", "355 Rue McGill", "690 Rue Notre-Dame Ouest", "407 Rue McGill", "106 Rue McGill", "244 Rue Saint-Jacques", "409 Rue McGill", "406 Rue Saint-Jacques" ];
	...
	"https://hotelstpaul.com/fr/", "https://www.thefarsides.com/?lang=fr", "http://restaurantholder.com/", "https://lecartet.ca/", "http://dandymtl.com/fr/", "https://le409.com/", "https://restaurantmonarque.ca/" ];
	...
	"Telus, bureaux montr&eacute;alais", "AlphaCCO", "Curateur Public du Qu&eacute;bec", "Ordre des Dentistes du Qu&eacute;bec", "Bombardier" ];
	...
	"800 Boulevard Ren&eacute;-L&eacute;vesque Ouest" ];
	...
	"https://www.vargas.ca/?lang=fr", "https://www.telus.com/fr/", "https://alphacco.com/", "https://www.curateur.gouv.qc.ca/cura/fr/index.html", "http://www.odq.qc.ca/Accueil/tabid/127/language/fr-CA/Default.aspx", "https://bombardier.com/fr" ];
	...
	"1250 Ren&eacute;-L&eacute;vesque", "Parc Julia-Drummond", "Auberge Les Bons Matins", "Roccabella" ];
	
	LucienLAlliertypes = [ "Sports", "Bureau", "R&eacute;sidence", "Coll&egrave;ge", "Bureau", "Bureau", "Coll&egrave;ge", "H&ocirc;tel", "H&ocirc;tel", "H&ocirc;tel", "H&ocirc;tel", "H&ocirc;tel", "Coll&egrave;ge", "Agence", "Bureau", "H&ocirc;tel", "Bureau", "Parc", "H&ocirc;tel", "R&eacute;sidence" ];
	...
	"1250 Boulevard Ren&eacute;-L&eacute;vesque Ouest", "", "1401 Avenue Argyle", "1059 Rue de la Montagne" ];
	...
	"https://imtl.org/edifices/IBM-Marathon.php", "https://montreal.ca/lieux/parc-julia-drummond", "https://www.bonsmatins.com/fr-ca", "https://roccabella.ca/" ];
